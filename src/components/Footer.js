    ...
    <FooterStyles>
      <div className="container">
        <div className="footer__col1">
          <h1 className="footer__col1__title">Johnny Vo</h1>
          <PText>
        ...
        <div className="footer__col4">
          <FooterCol
            ...
            links={[
              {
                title: 'Github',
                path: 'https://www.github.com/JvoProgramming',
              },
              {
                title: 'LinkedIn',
                path: 'https://www.linkedin.com/in/johnny-vo-063aa81a2/',
              },
              {
                title: 'Instagram',
                path: 'https://www.instagram.com/vogasm',
              },
            ]}
          />
        </div>
